...
class AddCartItemSerializer(serializers.ModelSerializer):
    ...
    def save(self, **kwargs):
        ...
        try:
            ...
            self.instance = CartItem.objects.create(cart_id=cart_id, **self.validated_data).save()
...
class CreateOrderSerializer(serializers.Serializer):
    ...
    def save(self, **kwargs):
        with transaction.atomic():
            ...
            (customer, creared) = Customer.objects.get_or_create(user_id=self.context['user_id'])
